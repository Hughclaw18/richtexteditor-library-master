/**
 * We have copy pasted this from columnresizing.js in prosemirror-tables package
 * We have not changed anything in this code, except the parameters that is passed to updateColumns function, because we have modified updateColumns function a bit
 * Inorder to know what changes we have made in updateColumns function, do check in tableView.js file
 */
...
function displayColumnWidth(view, cell, width, cellMinWidth) {
	...
	updateColumns(table, dom.firstChild, dom, cellMinWidth, col, width, view);
}
